...
class MOEA_D_PRE(BaseDecompositionEA):
    ...
    def __init__(  # parameters of the class
        ...
        sum_values_ref = np.sum(reference_point)

        self.mapping_point = reference_point/sum_values_ref
        self.ep = 1.0
    ...
    def _next_gen(self):
        #initWeight(ep)
        self.reference_vectors.adapt_moead_pre()
    ...
    def init_weights(self):
        self.mapping_point = self.get_mapping_points()
        self.reference_vectors.adapt_moead_pre(self.mapping_point, self.roi_size)
    ...
    def get_mapping_points(self): #refleckPoint
        sum_values= np.sum(self.reference_point)
        mapping_point = self.reference_point/sum_values
